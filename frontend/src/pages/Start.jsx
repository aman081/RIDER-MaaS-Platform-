...
const Start = () => {
  return (
    <div>
      <div className='h-screen bg-cover bg-bottom bg-[url(https://imgs.search.brave.com/Wy-f3ZTfp-UvHFPWIgW9yKU9cG78epYySJMMH-9zTHI/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly93d3cu/Y2l0eXBuZy5jb20v/cHVibGljL3VwbG9h/ZHMvcHJldmlldy9o/ZC0zZC10YXhpLWNh/Yi1jYXItdmVoaWNs/ZS1wbmctNzA0MDgx/Njk0ODc0MTEwemFv/OWpiaXBjZC5wbmc_/dj0yMDI1MDkxMjIy)] flex justify-between flex-col  w-full bg-red-400'>
